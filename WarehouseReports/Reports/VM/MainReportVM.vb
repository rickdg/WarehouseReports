...
#Region "Charts"
            ...
            CreateDoughnutChart(Linq.GetTasksByZone({100}), "O1", "Отбор бухт", 15, 10, 256, 240)
            CreateDoughnutChart(Linq.GetTasksByZone({300}), "M1", "Отбор барабанов", 15, 14, 256, 240)
            CreateDoughnutChart(Linq.GetTasksByZone(New Integer?() {203, 213}), "Q1", "Отбор железа", 15, 18, 256, 240)
            CreateDoughnutChart(Linq.GetTasksByUpDown({200}), "S1", "Отбор 200 верх/низ", 15, 22, 256, 240)
            CreateDoughnutChart(Linq.GetTasksByMainGroup({200, 500}), "W1", "Отбор по группам 200-500", 15, 26, 256, 240)
